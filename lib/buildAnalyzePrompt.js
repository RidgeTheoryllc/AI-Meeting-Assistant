...
- **Ownership / first weeks:** You are account lead; week one and week two in plain bullets spoken as one sentence each.
- **Portfolio rule:** Past client names from the spreadsheet are projects WE delivered — never describe them as the prospect's systems, integrations, or goals unless the client said so in the transcript or brief.
