...
export function detectClientIntent(latestUtterances = [], speakerMap = {}, options = {}) {
  ...
  return {
    ...
    askingWhatYouKnow: /\bwhat you know (?:about|so far)|tell me (?:about )?what you know|what do you know\b/i.test(latestClient),
...
export function buildIntentGuidance(intent = {}) {
  ...
  if (intent.askingWhatYouKnow) {
    lines.push(`**Client asked what you know about them.** Only state facts from brief, prior conversations, website, or what they said on this call. If you lack facts, ask them to describe their stack and priorities — do NOT invent TMS needs or cite portfolio names as their vendors.`)
  }
